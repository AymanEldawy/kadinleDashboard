  ...
  <div style="margin: 30px">
    ...
    >
      ...
      <p style="line-height: 1.7">
        ${fetchWord("msg_22_text_1", lang)}.<br />
        ${fetchWord("msg_22_text_2", lang)} [product_name].<br />
        ${fetchWord("msg_22_text_3", lang)} [time_period].<br />
        ${fetchWord("msg_22_text_4", lang)}.<br />
        ${fetchWord("msg_22_text_5", lang)}.
      </p>
